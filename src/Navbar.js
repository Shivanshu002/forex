...
function Navbar() {
    ...
    return (
        <>
            <nav className="bg-gradient-to-r from-purple-500 to-pink-500 w-full shadow-md sticky top-0  ">
                <div className="max-w-[1140px] mx-auto flex flex-row justify-between items-center sticky top-0   ">
                    <div className="text-2xl font-bold font-serif">
                        <Link to={'/'}>ABC FOREX PVT.LTD </Link>
                    </div>
                    <ul className='hidden md:flex text-white'>
                        <li className='p-5'><Link to={'/'}>Party</Link></li>
